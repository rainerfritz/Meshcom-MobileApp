...
const NodeMap = () => {
  ...
  const [ markerInfo, setMarkerInfo] = useState({ lat_: 48.20579, lon_: 16.37160, alt_:243, call_:"OE1KFR-4", bat_:"100", hw_:"RAK4631", press_:0, hum_:0, temp_:0, qnh_:0, timestamp_:0, comment_:"", temp_2_:0, co2_:0, gas_res_:0, alt_press_:0, neighbour_count_:0, groups_:"", symbol_table_:"", symbol_:"" });
